...
const SUCCESS_CODE = `{
  ...
  "data": {
    "transaction_id": "64dd1ede5bfbec88441a1a3d0899a24b",
    "transfer_amount": "0",
    "game_launch_url": "https://jsgame.live/game/gamesUrl?id=8c166f25-e603-4ad8-a0f6-d4f08a987051",
    "before_amount": "100.5",
    "currency": "USD",
    "transfer_id": "op_b707f86aff12",
    "transfer_status": 1,
    "after_amount": "100.5",
    "timestamp": 1785012549304
  }
}`;

const ERRORS_CODE = `// 502 — Transfer order already exists
{
  "success": false,
  ...
  "details": {
    "code": 2,
    "msg": "Launch failed",
    "raw": "{\\"code\\":10027,\\"msg\\":\\"The transfer order already exists\\",\\"payload\\":{\\"currency\\":\\"USD\\",\\"timestamp\\":1785012835463,\\"transfer_amount\\":\\"100.5\\",\\"before_amount\\":\\"100.5\\",\\"after_amount\\":\\"201.0\\",\\"transfer_id\\":\\"txn_abc12356\\",\\"transaction_id\\":\\"8a315ab5878cd5aa1e02cc58c3aba6cc\\",\\"transfer_status\\":1}}"
  }
}
...
// 502 — Game is not available
{
  ...
  "details": {
    "code": 2,
    "msg": "Launch failed",
    "raw": "{\\"code\\":10017,\\"msg\\":\\"Game is not available : vcxvxcvxcvcv\\",\\"payload\\":\\"\\"}"
  }
}
