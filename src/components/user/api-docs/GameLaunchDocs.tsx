...
const REQUEST_FIELDS: SchemaField[] = [
  ...
  },
  {
    ...
    required: true,
    description:
      'Credit amount for the session (maps to credit_amount). Requires 8% of balance ≤ your GGR balance (or your account’s configured GGR deduction %). Default: 0.',
  },
  {
    name: 'currencyCode',
    type: 'STRING',
...
// 400 — 8% of balance exceeds GGR balance
{
  "success": false,
    ...
    <div className="space-y-10">
      <section className="surface-card-premium p-5 sm:p-6">
        ...
        <ul className="mt-4 list-disc space-y-1 pl-5 text-sm text-[var(--fg-muted)]">
          ...
          <li>
            <code className="font-mono text-xs">balance</code> — 8% of balance cannot exceed your
            account GGR balance (HTTP 400). Your account may use a different deduction rate if set by
            admin.
          </li>
